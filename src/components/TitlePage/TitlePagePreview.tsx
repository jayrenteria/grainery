...
export function TitlePagePreviewPage({ titlePage }: { titlePage: TitlePageData | null }) {
  return (
    <div
      className="title-page-preview-sheet bg-white border border-base-300 shadow-inner overflow-hidden"
      style={{
        width: '425px',
        height: '550px',
  ...
  return (
    <Modal onClose={onClose} className="w-[90%] max-w-4xl">
      ...
      <div className="flex justify-center">
        ...
        <TitlePagePreviewPage titlePage={titlePage} />
      </div>
